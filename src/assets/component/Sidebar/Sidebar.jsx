        ...
        <div className="">
            ...
            <div className="text-[#364636] pt-24 fixed space-y-2  ">
                ...
                <NavLink to="/" className={({ isActive }) => "flex items-center justify-between w-[280px]"}>
                    {({ isActive }) => (
                        <div className="flex items-center justify-between w-[280px]">
                            <div className={`p-[3px] h-[60px] rounded-r-2xl ${isActive ? "bg-[#a8ccae]" : ""}`}></div>
                            <div className={`flex items-center space-x-2 justify-start w-[250px] h-[60px] pl-[30px] ${isActive ? "bg-[#8CAB91] text-[#FAF1E6]" : ""}`}>
                ...
                <NavLink to="/odermanagement">
                    <div className="flex items-center justify-between w-[280px]">
                        <div className={`p-[3px] h-[60px] rounded-r-2xl ${isActiveb ? "bg-[#8CAB91]" : ""}`}></div>
                        <div className={`flex items-center space-x-2 justify-start w-[250px] h-[60px] pl-[30px] ${isActiveb ? "bg-[#8CAB91] text-[#FAF1E6]" : ""}`}>
                ...
                <NavLink to="/addquestionnaire">
                    <div className="flex items-center justify-between w-[280px]">
                        ...
                        <div className={`flex items-center space-x-2 justify-start w-[250px] h-[60px] pl-[30px] ${isActiveo ? "bg-[#8CAB91] text-[#FAF1E6]" : ""}`}>
                ...
                <NavLink to="/makeadmin" className={({ isActive }) => "flex items-center justify-between w-[280px]"}>
                    {({ isActive }) => (
                        <div className="flex items-center justify-between w-[280px]">
                            <div className={`p-[3px] h-[60px] rounded-r-2xl ${isActive ? "bg-[#8CAB91]" : ""}`}></div>
                            <div className={`flex items-center space-x-2 justify-start w-[250px] h-[60px] pl-[30px] ${isActive ? "bg-[#8CAB91] text-[#FAF1E6]" : ""}`}>
                ...
                <div className={`${isManageSubscriptionActive ? 'bg-[#8CAB91] rounded-r-2xl w-[6px]' : ''}`}>
                    <div className="pl-[30px]">
                        ...
                        >
                            <div
                                className={`flex items-center space-x-2 justify-between w-[250px] h-[60px] pl-[30px] transition-all duration-300 cursor-pointer ${isManageSubscriptionActive ? 'bg-[#8CAB91] text-[#FAF1E6]  ' : ''}`}
                            >
                ...
                <div
                    className={` ml-[60px] w-[220px] overflow-hidden transition-all bg-white  duration-300 ${isOpen ? 'max-h-[200px] opacity-100' : 'max-h-0 opacity-0'}`}
                >
                    <NavLink
                        to="/subscription"
                        className={({ isActive }) =>
                            ` h-[60px] flex items-center w-[300px] pl-5 mr-[30px]  text-gray-700 hover:bg-[#a8ccae] hover:text-white font-[500] transition  ${isActivec ? 'bg-[#CBD9CC]' : ''}`
                        }
                    >
                        Subscription
                    </NavLink>
                    <NavLink
                        to="/coupon-code"
                        className={({ isActive }) =>
                            `flex items-center h-[60px] w-[300px] pl-5 mr-[30px] text-gray-700 hover:bg-[#a8ccae] hover:text-white font-[500] transition  ${isActived ? 'bg-[#CBD9CC]' : ''}`
                        }
                    >
                        Coupon Code
                    </NavLink>
                ...
                {/* <NavLink to="/setting" className={({ isActive }) => "flex items-center justify-between w-[280px]"}>
                    {({ isActive }) => (
                        <div className="flex items-center justify-between w-[280px] mt-2">
                            <div className={`p-[3px] h-[60px] rounded-r-2xl ${isActive ? "bg-[#a8ccae]" : ""}`}></div>
                            <div className={`flex items-center space-x-2 justify-start w-[250px] h-[60px] pl-[30px] ${isActive ? "bg-[#a8ccae] text-[#FAF1E6]" : ""}`}>
                ...
                <div className={`${isSettingActive ? 'bg-[#8CAB91] rounded-r-2xl w-[6px] ' : ''}`}>
                    <div className="pl-[30px]">
                        ...
                        >
                            <div
                                className={`flex items-center space-x-2 w-[250px] h-[60px] pl-[30px] transition-all duration-300 cursor-pointer ${isSettingActive ? 'bg-[#8CAB91] text-[#FAF1E6]' : ''}`}
                            >
                ...
                {/* Submenu (Animated Expand) */}
                <div
                    className={`ml-[60px] w-[220px] overflow-hidden transition-all bg-white duration-300 ${isSetting ? 'max-h-[200px] opacity-100' : 'max-h-0 opacity-0'}`}
                >
                    <NavLink
                        to="/termsCondition"
                        className={({ isActive }) =>
                            `h-[60px] flex items-center w-[300px] pl-5 mr-[30px] text-gray-700 hover:bg-[#a8ccae] hover:text-white font-[500] transition ${isActive ? 'bg-[#CBD9CC] text-[#FAF1E6]' : ''}`
                        }
                    >
                        Terms & condition
                    </NavLink>
                    <NavLink
                        to="/porivacyPolicy"
                        className={({ isActive }) =>
                            `flex items-center h-[60px] w-[300px] pl-5 mr-[30px] text-gray-700 hover:bg-[#a8ccae] hover:text-white font-[500] transition ${isActive ? 'bg-[#CBD9CC] text-[#FAF1E6]' : ''}`
                        }
                    >
                        Privacy policy
                    </NavLink>
                </div>
                <div className=" absolute top-[850px] ml-20 cursor-pointer flex items-center space-x-2 font-[600] text-[16px] overflow-hidden transition-all  duration-300">
