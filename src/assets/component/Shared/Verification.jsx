...
const Verification = ({ setIsProfileOpen }) => {
    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                onClick={() => setIsProfileOpen(false)} // Close modal when clicking outside
            >
                <motion.div
                ...
                >
                    <div className="flex items-center pl-80 pt-36 space-x-10">
                        ...
                        <div className="w-[573px] h-[810px] pt-36">
                            ...
                            <div className="flex justify-center mt-10 space-x-4">
                                {otp.map((digit, index) => (
                                    <input
                                        ...
                                        onPaste={handlePaste}
                                        className="w-12 h-12 text-center border rounded-md text-xl font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-200"
                                    />
                                ))}
                            </div>
                            ...
                            {/* Verify Button */}
                            <button
                                className="w-full mt-8 h-[48px] rounded-full bg-[#8CAB91] text-[#FAF1E6] font-medium text-base leading-[24px] hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-blue-400"
                            >
                                VERIFY
                            </button>
                            ...
                            <p className="text-center text-sm mt-5">
                                ...
                                <a href="/resend" className="text-blue-400 hover:underline">
                                    Resend
                                </a>
                            </p>
                        </div>
